...
gPats = [
    ...
    [r'(.*)how much fat(.*)',
     [
         ...
         "Men should aim for 30-38 grams of fiber a day while women should aim for 21 to 25 grams of fiber per day."
         ]],

    [r'(.*)how much carbs(.*)',
     ["Carbs should make up 45 to 65 percent of your total daily calories, so if you eat " + str(
         Eliza.cs) + " calories a day, " + " you should aim for " + str(Eliza.cs * .45) + " to " + str(
         (Eliza.cs * .65)) + " calories of your calorie surplus to be in carbs."
      ]],
    ...
    [r'(.*)carbs(.*)',
     [
         "Vegetables, quinoa, barley, legumes, potatoes, whole grains, are examples of whole carbs you should eat in a healthy diet.",
         "Fruits and vegetables will do the trick to stay fit", "White rice and oats if you want to bulk."
         ]],

    [r'(.*)protein(.*)',
     [
         "Whole eggs, chicken breast, cottage cheese, greek yogurt, lean beef, tuna are some examples of good meats for protein.",
    ...
    [r'(.*)fiber(.*)',
     ["Ah yes... fiber, the gut cleaner. Beans, broccoli, berries, avocados, and whole grains will do the trick.",
    ...
    [r'(.*)what should i eat?(.*)',
     ["Lets eat Pho! Good source of carbs and protein.",
...
def memory():
    ...
    print("You weigh " + str(Eliza.weight) + "lbs.") if Eliza.weight != -1 else print(
        "I don't know how much you weigh.")
    print("You are " + str(Eliza.age) + " years old.") if Eliza.age != -1 else print("I don't know your age.")
    print("Your favorite food is " + Eliza.ffood + " .") if Eliza.ffoodexists else print(
        "I don't know your favorite food because you never told me.")
    print("Your favorite beverage is " + Eliza.fdrink + ".") if Eliza.fdrinkexists else print(
        "I don't know your favorite drink because you never told me.")
    print("The macronutrient you are most curious about is " + maxMacro() + ".")
    print("You eat " + Eliza.meals + " meals per day.") if Eliza.meals != -1 else print(
        "I don't know how many meals you eat a day because you never told me.")
    print("Your fitness level is " + Eliza.fl + ".") if Eliza.fl != "" else print(
        "I don't know your fitness level because you never told me.")
    print("Your calorie surplus is about " + str(Eliza.cs) + " calories per day.") if Eliza.cs != 2000 else print(
        "I assume your calorie surplus is 2000 calories per day on average, since you have told me what your exact surplus is.")
    return ""
